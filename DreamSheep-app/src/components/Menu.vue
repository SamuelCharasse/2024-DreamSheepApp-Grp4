...
<template>
    <nav class="fixed bottom-0 inset-x-0 bg-indigo-900 rounded-t-lg">
        <ul class="flex flex-row justify-between items-center p-4 text-slate-50">
            <li>
                ...
                <img v-if="$route.path === '/'" src="./icons/EllipseMenu.svg" alt="Ellispe" class="h-3 w-3">
            ...
            <li>
                ...
                <img v-if="$route.path === '/diary'" src="./icons/EllipseMenu.svg" alt="Ellispe" class="h-3 w-3">
            ...
            <li>
                ...
                <img v-if="$route.path === '/profile'" src="./icons/EllipseMenu.svg" alt="Ellispe" class="h-3 w-3">
            ...
            <li>
                ...
                <img v-if="$route.path === '/shop'" src="./icons/EllipseMenu.svg" alt="Ellispe" class="h-3 w-3">
            ...
            <li>
                ...
                <img v-if="$route.path === '/settings'" src="./icons/EllipseMenu.svg" alt="Ellispe" class="h-3 w-3">
